...
const getImageElementStepOneParamsFromHtmlAttributes = (params: {src?: string, width?: string | number, height?: string | number}) => {
...
export const imageHtmlJsonNodeParser = async (node: HtmlJsonNode, getImageStepTwoParamsFn?: GetImageStepTwoParamsFn, options?: HtmlJsonNodeParserOptions) => {
