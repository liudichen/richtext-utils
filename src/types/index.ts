 ...
 * ```
 */
export type GetImageStepTwoParamsFn =
  | ((params: HtmlXmlParamsImageNodeStepOne) => HtmlXmlParamsImageNode)
  | ((params: HtmlXmlParamsImageNodeStepOne) => Promise<HtmlXmlParamsImageNode>);
