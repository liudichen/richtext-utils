 ...
 * @LastEditTime: 2022-11-07 18:52:54
 */
...
export const htmlStringToXmlElementGenerateParams: (htmlStr: string, config?: INodeStructAndConvertConfig) => Promise<(IGetParagraphXmlElementParams | IGetTableXmlElementParams)[]>;
