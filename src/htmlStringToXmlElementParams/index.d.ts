 ...
 * @LastEditTime: 2022-11-07 20:30:54
 */
...
export const htmlStringToXmlElementGenerateParams: (htmlStr: string, config?: INodeStructAndConvertConfig, getImageStepTwoParamsFn?: IGetImageStepTwoParamsFn) => Promise<(IGetParagraphXmlElementParams | IGetTableXmlElementParams)[]>;
