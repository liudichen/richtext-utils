 ...
 */
import { IGetTextXmlElementParams, IJsonNodeItem, INodeStructOptions } from '../../types';
 ...
 */
export const spanHtmlJsonNodeParser: (node: IJsonNodeItem, specailStyles: ISpanSepcialStyles, parentStyles: object, result:[], nodeStructOptions?: INodeStructOptions) => void;
